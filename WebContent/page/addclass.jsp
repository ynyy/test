...
<html>
	<head>
		<title>JP Interactive Class | Create Lectures</title>
		<!-- Bootstrap CSS -->
		...
		<section id="container">
		    ...
		    <section id="main-content">
		        <section class="wrapper">
		            ...
		            <div class="row">
		                <div class="col-lg-12">		        		               	                        
					         <h3 class="page-header"><i class="icon_book"></i>Create a New Lecture</h3>					                 
		                </div>
		            </div>
		            <br>
		            ...
		            <!-- Form validations start-->
		                <section class="panel" id="classInfoPanel">
		                    ...
		                    <div class="panel-body">
		                        <div class="form">
		                            <form class="form-validate form-horizontal" role="form"  action="<%=path %>/module?type=classAdd" method="post"  onsubmit="return check()">
		                                <div class="form-group ">
		                                    <label for="classname" class="control-label col-lg-2">Lecture Name <span class="required">*</span></label>
		                                    <div class="col-lg-10">
		                                        <input class="form-control" id="classname" name="classname" placeholder="Enter the name of the new lecture" type="text" required />
		                                    </div>
		                                </div>
		                                <div class="form-group ">
		                                ...
		                                <!--label的for规定label与哪一个表单元素绑定  -->
		                                    <label for="comment" class="control-label col-lg-2"> Date of the Lecture <span class="required">*</span></label>
		                                    <div class="col-lg-10">
		                                        <input class="form-control" id="comment" name="comment" placeholder="Enter the date of the lecture" type="text" required />
		                                    </div>
		                                </div>
		                                <div class="form-group">
