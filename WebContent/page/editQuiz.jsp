...
if((Tuser)request.getSession().getAttribute("user")!=null){
	...
	if(user==null){
%>
<%=request.getAttribute("attemptID")%>
...
<html>
	<head>
		<title>JP Interactive Class | Edit quiz</title>
		<!-- Bootstrap CSS -->
		...
		<section id="container">
		    ...
		    <section id="main-content">
		        <section class="wrapper">
		            ...
		            <div class="row">
		                <div class="col-lg-12">		        		               	                        
					         <h3 class="page-header"><i class="icon_book"></i>Edit the Quiz</h3>					                 
		                </div>
		            </div>
		            <br>
		            ...
		            <!-- Form validations start-->
		                <section class="panel" id="classInfoPanel">
		                    ...
		                    <div class="panel-body">
		                        <div class="form">
		                            <form class="form-validate form-horizontal" role="form"  action="<%=path %>/quiz?type=attemptUpdate&attemptID=${requestScope.attemptID}" method="post"  onsubmit="return check()">
		                                <div class="form-group ">
		                                <!--label的for规定label与哪一个表单元素绑定  -->
		                                    <label for="quizname" class="control-label col-lg-2">Quiz Name <span class="required">*</span></label>
		                                    <div class="col-lg-10">
		                                        <input class="form-control" id="quizname" name="quizname" value="${attemptID}" placeholder="Enter the name of the new quiz" type="text" required />
		                                    </div>
		                                </div>
		                                <div class="form-group ">
		                                <!--label的for规定label与哪一个表单元素绑定  -->
		                                    ...
		                                    <div class="col-lg-10">
			                                    <select class="form-control" id="classname" name="classname" value="${class_name}">
			                                    </select>
		                                    </div>
		                                </div>
				                         <div class="form-group ">
		                                    ...
		                                    <div class="col-lg-10">
			                                    <select class="form-control" id="moduleID" name="moduleID" value="${module_name}"></select>
		                                ...
		                                <!--label的for规定label与哪一个表单元素绑定  -->
		                                    ...
		                                    <div class="col-lg-10">
		                                        <input class="form-control" id="comment" name="comment" value="${attempt_comment}" placeholder="Enter the date of the new quiz" type="text" required />
		                                    </div>
		                                </div>
		                                <div class="form-group">
