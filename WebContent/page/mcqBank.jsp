...
<html>
<head>
<title>JP Interactive Class | MCQ Bank</title>
			    ...
			    function init1(){
			    	var _scrollTop = $(document).scrollTop();
		             $.ajax({  
			  	         ...
			  	         cache:true,  
			  	         type: 'POST',  
			  	         url: "<%=path%>/quiz?type=mcqOfClassJson&classID=${requestScope.classID}&quizID=${requestScope.quizID}&attemptID=${requestScope.attemptID}",//请求的action路径  
			  	         ...
			  	         success:function(data){ //请求成功后处理函数。    
			                   ...
			                   for (var i = 0; i < obj.length; i++){
				                     ...
				                     html = html + ("<a href=\"<%=path%>/quiz?type=mcqReuse&quizID=${requestScope.quizID}&attemptID=${requestScope.attemptID}&mcqID="+obj[i].mcqID+"\" > <span class=\"badge bg-primary\">Reuse this MCQ</span></a>"); 				                     
			...
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu">
					<li class="sub-menu"><a href="<%=path%>/module?type=mylecture">
							<i class="icon_house_alt"></i> <span>My Lecture</span>
					</a></li>
