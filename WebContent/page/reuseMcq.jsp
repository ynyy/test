...
<script type="text/javascript">
	...
	//	alert("url:"+url);
		...
		$.ajax({
			...
			cache : true,
			type : 'POST',
			url : "<%=path%>/quiz?type=mcqAddFromReuse&quizID=${requestScope.quizID}&attemptID=${requestScope.attemptID}&mcqID=${requestScope.mcqID}",
			data : {
				optionA : opA,
				optionB : opB,
				optionC : opC,
				...
				<div class="cont span_2_of_3">
					<div class="labout span_1_of_a1">
						...
						<form action="" method="post">
							<br /> <B>Option A : </B> <input type="text/javascript"
								class="form-control" style="width:600px;" id="optionA"
								name="optionA" value="${mcq_optionA}" /> <br /> <B>Option
								B : </B> <input type="text/javascript" class="form-control"
							...
							<B>Option C : </B> <input type="text/javascript"
								...
								value="${mcq_optionC}" /> <br /> <B>Option D : </B> <input
