...
<title>JP Interactive Class | Answer succeeds page</title>
...
<div class="shopimg"><img src="<%=path %>/upload/succSub.png" width="512" height="512"  alt=""/></div>


<div class="publick_box mdxx">
	  <br>
      	<h1 align="center">Your answers have been submitted!</h1>
      <br>
</div>

<%-- <div align="center" class="tijiao" >
	<input type="button" style="width:300px" class="tjbtn" value="Return" onclick="javascript:window.location.href='<%=path%>/quiz?type=studentQuizDetail'">
</div> --%>
